...
export default function HeroSection() {
	...
	return (
		<div className="flex flex-col h-full">
			<div className="h-[55%] w-full grid grid-cols-1 md:grid-cols-5 grid-rows-4">
				<div className="col-start-1 md:col-start-2 col-span-1 md:col-span-3 row-start-2 row-span-3 flex flex-col">
					...
					<Card className="text-4xl md:text-8xl font-bold flex items-center justify-center flex-grow">
						<CardContent>
							<span>hey! i'm </span>
			...
			<div
				ref={ribbonRef}
				className="flex h-[5%] items-center text-base md:text-lg w-full border border-x-0 overflow-hidden"
			>
				<div
			...
			<div className="flex-1 w-full">
				<div className="grid h-full grid-cols-1 md:grid-cols-5 grid-rows-5 gap-4">
					<Card className="col-start-1 md:col-start-2 row-span-5 p-4 md:p-6 flex flex-col items-center justify-center">
					...
					<Card className="col-start-1 md:col-start-3 col-span-1 md:col-span-2 row-span-4 p-4 md:p-6">
						<div className="prose text-base md:text-xl prose-invert max-w-none">
							<p>
								i do <span className="text-cyan-400">machine learning</span>,{" "}
								<span className="text-emerald-400">deep learning</span>, and{" "}
								<span className="text-amber-400">AI research</span>. at 17, i'm diving into{" "}
								<span className="text-purple-400">multivariable calculus</span>,{" "}
								<span className="text-pink-400">linear algebra</span>, and{" "}
								<span className="text-blue-400">differential equations</span> to build{" "}
								<span className="text-green-400">neural architectures</span> that actually work.
							</p>
							<br />
							<p>
								often you'll find me exploring the frontiers of AI and
								building models that{" "}
								<span className="text-rose-400 font-semibold">push boundaries</span>.
							</p>
						</div>
					</Card>
					<div className="border border-border col-start-1 md:col-start-3 col-span-1 md:col-span-2 flex items-center justify-center p-4 font-mono text-xs md:text-sm overflow-hidden">
